...
if ($_POST) {
  ...
  echo "<p>Außerdem hast du bis Heiligabend Zeit, deine Meinung noch einmal zu ändern (wenn du möchtest). Heiligabend wird der Kalendergruppenspender dann alle Spenden vornehmen. :)</p></div>";
